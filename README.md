...
<p style="text-align:justify;"> Sesamum indicum L. is one of the major oil crop traditionally used in Korean food culture as cooking oil, seasoning or decoration food ([Kim et al. 2016](https://www.sciencedirect.com/science/article/pii/S2352618116300099)). This member of mint family harbors valuable nutritional and health benefits to human mainly for lignans (sesamin, sesamolin, sesaminol and sesamol). Based on the recent Korean nutritional and health survey, the daily lignan intake from sesame oil is up to 77% with 18.39 mg  and 13.26 mg per person for males and females respectively ([Kim et al. 2020](https://www.mdpi.com/2304-8158/9/4/394)). 
...
Initial genome was rendered using BAC clone and short-read approchaes using Yuzhi11 cultivar ([Zhang et al. 2013](https://genomebiology.biomedcentral.com/articles/10.1186/gb-2013-14-1-401)). Meanwhile, the Oil Crop Research Institute (OCRI) generated a contig level assembly ([Wang et al. 2014](https://genomebiology.biomedcentral.com/articles/10.1186/gb-2014-15-2-r39)) that have been updated in linkage group later on ([Wang et al. 2016](https://bmcgenomics.biomedcentral.com/articles/10.1186/s12864-015-2316-4)). The availaibility of the reference Chinese cultivars Zhongzhi13 facilitate the identification and validation of molecular marker relative to seedcoat color, plant height ([Wang et al. 2016](https://bmcgenomics.biomedcentral.com/articles/10.1186/s12864-015-2316-4)) yield components ([Wei et al 2015](https://www.nature.com/articles/ncomms9609#Sec8), [Zhou et al 2018](https://www.mdpi.com/1422-0067/19/9/2794)), drought and salinity stress ([Dossa et al. 2019](https://onlinelibrary.wiley.com/doi/full/10.1111/pbi.13100), [Li et al. 2018](https://www.mdpi.com/2073-4425/9/2/87)), root biomass ([Dossa et al. 2020](https://onlinelibrary.wiley.com/doi/full/10.1111/pbi.13531)), and waterlogging stress ([Wang et al. 2021](https://www.sciencedirect.com/science/article/pii/S0888754320320206)).
Moreover, a pangenome was constructed based on one Indian cultivar (S. indcum cv. Swetha) and four Chinese genotypes including  two cultivars (S. indicum var. Zhongzhi13 and S. indicum var. Yuzhi11) and two landraces (S. indicum cv. Baizhima and S. indicum cv. Mishuozhima) ([Yu et al. 2018](https://onlinelibrary.wiley.com/doi/full/10.1111/pbi.13022)).
The strategies employed for the pangenome was based on a single reference assembly (Zhongzhi13) as a backbone representative. Despite the huge contribution of this single refence genome, it cannot represent properly the complete genomic sequence diversity in Sesame species. Therefore the need of reference-free high quality genome resource from different origins may help to get inside into the variability among genotypes at genomic level. Besides, having a good quality of the korean cultivar genome will drastically improve the ongoing korean sesamum breeding activities for oil, lignans ([Lee et al. 2017](https://link.springer.com/article/10.1007/s10068-017-0010-9)), and disease restistance ([Asegova et al. 2021](https://www.frontiersin.org/articles/10.3389/fpls.2021.604709/full)).</p>


The modern cultivar Goenbaek exhibited four locules per capsule, high seed yield characteristics and resistance to sesamum Phytophtora blight resistance ([Kim et al. 2018](http://www.koreabreedjournal.org/journal/view.html?doi=10.9787/KJBS.2018.50.3.256), [Asegova et al. 2021](https://www.frontiersin.org/articles/10.3389/fpls.2021.604709/full))  
To speed up the Korean genomic-assisted sesame breeding program, a chromosomal-grade genome assembly of this cultivar was generated using Short-read, long-reads and chromosome conformation Hi-C technologies. 
