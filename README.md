...
The strategy employed for the pangenome construction relied on reference-based assembly with Zhongzhi13 as a backbone representative. Despite the huge contribution of this single refence genome, it cannot represent properly a comprehensive sequence diversity in Sesame species. Therefore, the need of reference-free high-quality genome resources  may help to get inside into the variability among genotypes relatives to traits of interest. Besides, having a good quality of the korean cultivar genome will drastically improve the ongoing korean sesamum breeding activities for oil, lignans ([Lee et al. 2017](https://link.springer.com/article/10.1007/s10068-017-0010-9)), and disease restistance ([Asegova et al. 2021](https://www.frontiersin.org/articles/10.3389/fpls.2021.604709/full)).
