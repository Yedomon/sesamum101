...
Initial genome was rendered using BAC clone and short-read approchaes with Yuzhi11 cultivar ([Zhang et al. 2013](https://genomebiology.biomedcentral.com/articles/10.1186/gb-2013-14-1-401)). Meanwhile, the Oil Crop Research Institute (OCRI) generated a contig level assembly ([Wang et al. 2014](https://genomebiology.biomedcentral.com/articles/10.1186/gb-2014-15-2-r39)) that have been updated in linkage groups later on ([Wang et al. 2016](https://bmcgenomics.biomedcentral.com/articles/10.1186/s12864-015-2316-4)). The availaibility of the reference Chinese cultivar Zhongzhi13 facilitated the identification and validation of molecular marker relative to seedcoat color, plant height ([Wang et al. 2016](https://bmcgenomics.biomedcentral.com/articles/10.1186/s12864-015-2316-4)), seed yield components ([Wei et al 2015](https://www.nature.com/articles/ncomms9609#Sec8), [Zhou et al 2018](https://www.mdpi.com/1422-0067/19/9/2794)), drought and salinity stress ([Dossa et al. 2019](https://onlinelibrary.wiley.com/doi/full/10.1111/pbi.13100), [Li et al. 2018](https://www.mdpi.com/2073-4425/9/2/87)), root biomass development ([Dossa et al. 2020](https://onlinelibrary.wiley.com/doi/full/10.1111/pbi.13531)), and waterlogging stress ([Wang et al. 2021](https://www.sciencedirect.com/science/article/pii/S0888754320320206)).
...
The strategy employed for the pangenome construction relied on reference-based assembly with Zhongzhi13 as a backbone representative. Despite the tremendous contributions of this single refence genome for sesame breeding, the knowledge about the extent of structural variations and sequence diversity is limited. Therefore, the need of reference-free high-quality genome resources  may help to get inside into the variability among genotypes relatives to traits of interest. Besides, having a good quality of the korean cultivar genome will drastically improve the ongoing korean sesamum breeding activities for oil, lignans ([Lee et al. 2017](https://link.springer.com/article/10.1007/s10068-017-0010-9)), and disease restistance ([Asegova et al. 2021](https://www.frontiersin.org/articles/10.3389/fpls.2021.604709/full)).
